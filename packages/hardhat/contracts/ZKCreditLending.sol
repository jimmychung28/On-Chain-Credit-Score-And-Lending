...
contract ZKCreditLending is Ownable, ReentrancyGuard {
    ...
    {
        // Get user profile
        (uint256 score, , bool isActive, uint8 userPrivacyLevel, bool isVerified) = zkCreditScoring.getCreditProfile(
            borrower
        );
     ...
     */
    function getLenderInfo(address lender) external view returns (uint256 totalShares, uint256 sharePercentage) {
